...
core_CD8prolif.m - contains ODEs for model where basophils promote proliferation of CD8 T cells

core_TregDeath_CD8prolif.m - contains ODEs for model where basophils promote death of Tregs and proliferation of CD8 T cells
