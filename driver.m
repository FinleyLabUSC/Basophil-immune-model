...
figure(1);
bar(percentages);
set(gca,'XTickLabel',labels,'XTickLabelRotation',45,'FontSize',12);
ylabel('Cancer cell death (%)');
ylim([0 ceil(max(percentages)/10)*10]); % tidy y-axis
title('Cancer cell death at final timepoint');
grid off;


%-- plot simulated dynamics for the cell counts
